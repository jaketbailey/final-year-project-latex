...
Manual unit tests were conducted on the front end to ensure that the components behaved as expected. The application was run through set tasks to ensure functionality \see{tab:unit-test-results}.
