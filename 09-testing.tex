...
A multi-faceted approach to testing was used where all core logic was tested to ensure the reliability of the final product. Using the combination of Unit Testing \see{testing:unit}, Postman \see{testing:postman} and Chrome/React Developer Tools \see{testing:chrome-dev} enabled effective software development throughout the project, ensuring all deadlines were met and that the artefact was delivered to a high standard.