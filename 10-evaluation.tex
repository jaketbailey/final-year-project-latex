...
\begin{itemize}
    \item Rewriting Routing UI to increase modularity and efficiency of the code.
    \item Improving route import, including support for Garmin, Strava and other services.
    \item Minimise number of floating overlays and integrate into core UI elements.
    \item Improve round trip support, build native support for round trips.
\end{itemize}
...
\begin{itemize}
    ...
    \item Implementing a system to allow sharing of1 routes with other users.
\end{itemize}