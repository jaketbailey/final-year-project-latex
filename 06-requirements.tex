...
Requirements were prioritised using the feedback received from the research appilication, a series of graphs were created to demonstrate the order of priority based on user feedback \see{fig:userfeedback01}.
