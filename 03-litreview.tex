...
This chapter presents the analysis and review of relevant literature conducted throughout this project. The research comprises literature surrounding current solutions \see{litrev:competingproducts} and risk-based route planning \see{litrev:riskfactors}.
...
\begin{figure}
    \centering
    \includegraphics[width=400px, keepaspectratio]{figures/bicycle_infrastructure_scores.jpg}
