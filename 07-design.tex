...
\label{ui:low-fi}
  ...
  \begin{figure}[!ht]
    \centering
    \includegraphics[width=400px]{figures/lofi-1-min.png}
    \caption{Lo-Fidelity Design 1}
    \label{fig:lofi1}
  \end{figure}

  \begin{figure}[!ht]
    \centering
    \includegraphics[width=400px]{figures/lofi-2-min.png}
    \caption{Lo-Fidelity Design 2}
    \label{fig:lofi2}
  \end{figure}
